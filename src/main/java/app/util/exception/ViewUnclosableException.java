...
public class ViewUnclosableException extends ViewException {
     ...
     */
    public ViewUnclosableException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public ViewUnclosableException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public ViewUnclosableException(Throwable cause) {
        super(cause);
    }
}
