...
public class ViewInitException extends ViewException {
     ...
     */
    public ViewInitException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public ViewInitException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public ViewInitException(Throwable cause) {
        super(cause);
    }
}
