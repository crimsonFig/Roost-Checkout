...
public class OutEntry {
	...
	public OutEntry(String name, int banner, Station station, ObservableList<StringProperty> equipment ) {
		this.name = name;
		this.banner = banner;
	...
	public OutEntry(String name, int banner, String station, String equipment ) {
		this.name = name;
		this.banner = banner;
